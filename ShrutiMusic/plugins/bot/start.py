...
if name[0:4] == "help":
keyboard = help_pannel_page1()
try:
return await message.reply_photo(
photo=config.START_IMG_URL,
caption=["help_1"].format(config.SUPPORT_GROUP),
...
searched_text = ["start_6"].format(
title, duration, views, published, channellink, channel, app.mention
)
key = InlineKeyboardMarkup(
[
[
InlineKeyboardButton(text=["S_B_8"], url=link),
InlineKeyboardButton(text=["S_B_9"], url=config.SUPPORT_GROUP),
],
]
)
await m.delete()
...
photo=config.START_IMG_URL,
caption=["start_2"].format(message.from_user.mention, app.mention, UP, DISK, CPU, RAM),
